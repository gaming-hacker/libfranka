...
class VacuumGripper {
 public:
   ...
   */
  auto operator=(VacuumGripper&& vacuum_gripper) noexcept -> VacuumGripper&;
   ...
   */
  [[nodiscard]] auto vacuum(uint8_t vacuum,
              std::chrono::milliseconds timeout,
              ProductionSetupProfile profile = ProductionSetupProfile::kP0) const -> bool;
   ...
   * @throw NetworkException if the connection is lost, e.g. after a timeout.
   */
  [[nodiscard]] auto dropOff(std::chrono::milliseconds timeout) const -> bool;
   ...
   */
  [[nodiscard]] auto readOnce() const -> VacuumGripperState;
  ...
  auto operator=(const VacuumGripper&) -> VacuumGripper& = delete;
  /// @endcond
