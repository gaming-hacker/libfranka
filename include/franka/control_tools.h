 ...
 */
inline auto isValidElbow(const std::array<double, 2>& elbow) noexcept  -> bool {
 ...
 */
inline auto isHomogeneousTransformation(const std::array<double, 16>& transform) noexcept  -> bool{
 ...
 */
auto setCurrentThreadToHighestSchedulerPriority(std::string* error_message) -> bool;
