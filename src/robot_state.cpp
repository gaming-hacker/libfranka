...
auto operator<<(std::ostream& ostream, const std::array<T, N>& array) -> std::ostream& {
  ostream << "[";
...
auto operator<<(std::ostream& ostream, const RobotMode robot_mode) -> std::ostream& {
  ostream << "\"";
  switch (robot_mode) {
...
auto operator<<(std::ostream& ostream, const franka::RobotState& robot_state) -> std::ostream& {
